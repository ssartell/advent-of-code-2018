...
var solution = R.pipe(parseInput, R.sortBy(R.prop('datetime')), fixIds, filterBeginShifts, expandMinutes, groupProp('id'), R.map(groupProp('min')), R.unnest, maxArrayLength, R.head, answer);
